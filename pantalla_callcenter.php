      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id"myNavbar<!-- ">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="">	Panel de Call Center</a></li>
...
<div class="container-fluid theme-showcase" role="main" style="padding-left: 0px; padding-right: 0px;">
    ...
    <h2 class="bg-primary" style="margin-top:0px; margin-bottom: 0px; text-align: center; font-size: 40px;">
    	TABLERO DE CALL CENTER <span class="pull-right" style="margin-right: 5px;"><span class="glyphicon glyphicon-calendar"></span> <span id="fechaTablero"></span></span>
    	<div class="btn-group pull-left">
			...
			<ul class="dropdown-menu" role="menu" style="font-size: 20px; margin-bottom: 5px;">
...
<div class="container-fluid" style="font-size: 35px; font-weight: bold;">
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">24 Hs</a></li>
    <li><a data-toggle="tab" href="#menu1">7 Dias</a></li>
    <li><a data-toggle="tab" href="#menu2">Cancelados</a></li>
  </ul>


  <div class="row">
    <div class="col-xs-4" style="background-color:#337ab7; color:white;" >
    	<span class="glyphicon glyphicon-calendar"></span> AGENDADO
    	<span class= "pull-right" id="Tagendados" ></span>
    </div>
    <div class="col-xs-4" style="background-color:#fcf8e3; color:#8a6d3b;" >
    	<span class="glyphicon glyphicon-user"></span> ATENDIDO
    	<span class= "pull-right" id="Tatendidos" ></span>
    </div>
    <div class="col-xs-4" style="background-color:#dff0d8; color:#3c763d; position: relative;">
    	<span class="glyphicon glyphicon-cog"></span> EN PROCESO
    	<span class= "pull-right" id="Tprocesos" ></span>
    </div>
  </div>
</div>    
...
window.setInterval(function(){ $.post('refresh_session.php'); },300000); 
	...
	function estadoTaller(dia ){
		if ( dia == 0 ) { $("#listado").html(  'HOY' ); }

		dia = 1 ;
		var jqxhr1 = $.ajax( { method: "POST" , url: 'inc/procesos.php', data: { accion: "estadoCallcenter" , dia : dia  }, dataType: 'json', encoding:"ISO-8859-1"});
		jqxhr1.done(function(rs) { //recuperar datos de turnos 
			//total agendados
			$("#Tagendados").html(rs.length);

			var html = ""; item = 0 ; color = ""; estado = ""; atendidos= 0 ;
			rs.forEach( function ( rs2 ){
				...
				html = html + '<tr style="background-color:'+ color +';"><td><center>' 
							+ item            + '</center></td><td>'  
							+ rs2["horarios"] + '</td><td>'  
							+ rs2["boxes"]    + '</td><td>'  
							+ rs2["cliente"]  + '</td><td>'  
							...
							+ rs2["estado"]   + '</b></center></td> <td style="padding-top:1px;" class="btn-danger"><center><b>'
							+ '<span class="glyphicon glyphicon-earphone" style="font-size:30px; margin-top:10px;" onclick="llamar()"></span></center></td></tr>';
	...
	function llamar(){
		var html = '<div class="container-fluid" style=" min-height:530px;">'+
					'	<div class="row">'+
					'		<div class="col-xs-5 " style=" min-height:530px; padding:0px;">'+
					'			<div class="col-xs-12" style="height:100px; background-color:#ccc; margin-left:0px; margin-right:0px;"></div>'+
					'			<span class="glyphicon glyphicon-user" style="margin-left:33%; padding:15px; font-size:65px; background-color:white; border-radius: 45px; position:relative; top:-30px; color:#ccc;"></span>'+
					'			<h2 style="text-align:center; margin:0px; position:relative; top:-30px;"><strong>Favio Cabral Olmedo</strong></h2>'+
					'			<ul class="list-group" style="font-size:20px;">'+
					'				<li class="list-group-item"><span class="glyphicon glyphicon-list-alt"></span> First item</li>'+
					'				<li class="list-group-item"><span class="glyphicon glyphicon-phone-alt"></span> 0981-123-123</li>'+
					'				<li class="list-group-item"><i class="fa fa-car fa-lg"></i> Third item</li>'+
					'				<li class="list-group-item"><span class="glyphicon glyphicon-wrench"></span> Diagnostico y Mantenimiento</li>'+
					'				<li class="list-group-item"><span class="glyphicon glyphicon-time"></span> 2 hs</li>'+
					'				<li class="list-group-item"><span class="glyphicon glyphicon-earphone"></span> Call Center</li>'+
					
					'			</ul>'+
					'		</div>'+
					'		<div class="col-xs-7 " style="background-color:#; min-height:530px; padding-left:0px; padding-right:0px;">'+
					'			<div class="btn-group btn-group-justified">'+
					'				<a href="#" class="btn btn-success" style="height:100px;">CONFIRMAR</a>'+
					'				<a href="#" class="btn btn-danger" style="height:100px;">CANCELAR</a>'+
					'				<a href="#" class="btn btn-warning" style="height:100px;">REAGENDAR</a>'+
					'			</div>'+
					'		</div>'+
					'	</div'+
					'</div>';
		$("#msj").html(html);
		$("#titulo").html('LLAMAR A CLIENTE');
